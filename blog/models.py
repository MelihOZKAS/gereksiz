...
class Post(models.Model):
    ...
    SosyalDik = models.BooleanField(default=False, help_text="1920 x 1080 Resim üret")
    SosyalKare = models.BooleanField(default=False, help_text="Havanın Wp Attığı Post Turu")
